...
type Provider interface {
	...
	// GetEmbeddingDimension returns the dimension of embeddings generated by this provider
...
func (r *RetryableProvider) GetEmbeddingDimension() uint64 {
	return r.provider.GetEmbeddingDimension()
}
