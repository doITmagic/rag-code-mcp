...
### All Tests
```bash
go test ./v2/pkg/workspace/tests -v
```

### Specific Test
```bash
go test ./v2/pkg/workspace/tests -run TestResolverScenarios -v
```

### With Race Detector
```bash
go test ./v2/pkg/workspace/tests -race -v
```

### Coverage
```bash
go test ./v2/pkg/workspace/tests -cover
```
